...
from Options import PerGameCommonOptions, Range, Choice, DeathLink, OptionGroup, OptionSet, DefaultOnToggle
...
class GameVersions(OptionSet):
    ...
    valid_keys = list(WaccaCollections.VERSIONS.keys())
    default = ["WACCA", "Lily", "Reverse", "Plus"]
